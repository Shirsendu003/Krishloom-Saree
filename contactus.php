            ...
            <li>
                ...
                <li>
                  <a href="cart.php" class="">
                   ...
                   <li>
                   <a  href="customer_registration.php"><i class="fa fa-user-plus"></i>  Sign in</a></li>
                   <li>
                   <?php
    ...
    <div class="rx">
      ...
      <div>
        <form action="contactus.php" method="post">
          ...
          <div class="roup">
            <!-- <label>Subject</label> -->
            <input type="text" name="submit" placeholder="Subject" class="form-control" required="">
          </div>
          <div class="roup">
            <!-- <label>Massage</label> -->
            <textarea class="form-control" placeholder="Type Message" name="massage"></textarea>
          </div>
          <center>
