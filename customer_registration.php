            ...
            <li>
                ...
                <li>
                  <a href="cart.php" class="">
                   ...
                   <li>
                   <a class="active" href="#customer_registration.php"><i class="fa fa-user-plus"></i>  Sign in</a></li>
                   <li>
                   <?php
      ...
      <div>
        <form action="customer_registration.php" method="post" enctype="multipart/form-data">
          <div class="roup">
            ...
            <input type="text" name="c_name" placeholder="Enter Your Name" required="" class="form-control">
          </div>
          <div class="roup">
            <!-- <label>Customer Email</label> -->
            <input type="text" name="c_email" placeholder="Enter Your Email" class="form-control" required="">
          ...
          <div class="roup">
            <!-- <label>Country</label> -->
            <input type="text" name="c_country" placeholder="Enter Your Country Name" class="form-control" required="">
            
          </div>
         
        <div class="roup">
            <!-- <label>City</label> -->
            <input type="text" name="c_city" placeholder="Enter Your City Name" class="form-control" required="">
            
          </div>
          <div class="roup">
            <!-- <label>Contact Number</label> -->
            <input type="text" name="c_contact" placeholder="Enter Your Contact Number" class="form-control" required="">
            
          </div>
          <div class="roup">
            <!-- <label>Address</label> -->
            <input type="text" name="c_address" placeholder="Enter Your Address" class="form-control" required="">
          ...
          <div class="text-center">
            <button type="submit" name="submit" class="reg_button">
